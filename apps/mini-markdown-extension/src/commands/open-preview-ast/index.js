...
export async function openPreviewAst(context) {
  ...
  const panel = vscode.window.createWebviewPanel(
    "miniMarkdownPreviewAst",
    "Mini Markdown Preview (Abstract Syntax Tree)",
  ...
  const styleUri = panel.webview.asWebviewUri(
    vscode.Uri.joinPath(context.extensionUri,
      "dist",
      "open-preview-webview-ast.css")
  );

  const scriptUri = panel.webview.asWebviewUri(
    vscode.Uri.joinPath(context.extensionUri,
      "dist",
      "open-preview-webview-ast.js")
  );
